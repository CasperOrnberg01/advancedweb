...
| 23.4 | 3 | Worked on fixing the integration problem with azure db (postgresql), frontend(azure static web app) and backend (azure web app).  | Successfully integrated backend+frontend and db  |
| x | x | x  | x  |
| x | x | x  | x  |
| x | x | x  | x  |
| x | x | x  | x  |
